...
#
# Changes:
# 2023-09-14: updated epsilon value to detect end points
...
proc runFEPlist { lambdaList nSteps { IDWS false } { prev_lambda -1 } } {
    # The value of epsilon should be greater than the largest numerical error on calculated
    # lambda values, but less than the smallest window width defined by users
    # Largest user-reported error is 1e-14
    set epsilon 1e-12
